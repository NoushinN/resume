...
You can either edit the `make_resume.Rmd` file [directly in Github](https://github.com/NoushinN/resume/blob/main/rmd_file/make_resume.Rmd) or edit from your computer terminal in a RStudio IDE environment and render in either HTML or PDF. 

An example is shown below:

![Example output](rmd_file/example.png)
